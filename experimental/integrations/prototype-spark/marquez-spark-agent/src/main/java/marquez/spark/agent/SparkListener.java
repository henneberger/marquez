...
public class SparkListener {
  ...
  public static void instrument(SparkContext context) {
    ...
    SparkListenerInterface listener = (SparkListenerInterface)Proxy
        .newProxyInstance(SparkListener.class.getClassLoader(), interfaces,
            (proxy, method, args) -> {
  ...
  public static SparkSQLExecutionContext getSparkSQLExecutionContext(long executionId) {
    return sparkSqlExecutionRegistry
        .computeIfAbsent(executionId, (e)-> new SparkSQLExecutionContext(executionId, marquezContext));
  }


  public static ExecutionContext getExecutionContext(int jobId) {
    return rddExecutionRegistry
        .computeIfAbsent(jobId, (e) -> new RddExecutionContext(jobId, marquezContext));
  }
