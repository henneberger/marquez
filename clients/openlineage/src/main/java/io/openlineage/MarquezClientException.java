...
public class MarquezClientException extends RuntimeException {
  ...
  MarquezClientException(final String message) {
    super(message);
  }

  /** Constructs a {@code MarquezClientException} with the cause {@code cause}. */
  MarquezClientException(final Throwable cause) {
    super(cause);
  }
   ...
   * {@code cause}.
   */
  MarquezClientException(final String message, final Throwable cause) {
    super(message, cause);
  }
}
